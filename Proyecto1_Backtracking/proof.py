...
def paint_matrix_gui(buttons, n,function, label):
    ...
    messagebox.showinfo("DURACION:",elapsedTime)
...
def ventana_de_game():
    ...
    button_game1x1 = Button(ventana, width=4, bg="black", state="disabled", height=2, text="")
    button_game1x1.place(x=100, y=100)
    buttons.append(button_game1x1)
    fila1.append(button_game1x1)

    button_game1x2 = Button(ventana, width=4, height=2, bg="black", state="disabled")
    button_game1x2.place(x=100, y=142)
    buttons.append(button_game1x2)
    fila2.append(button_game1x2)

    button_game1x3 = Button(ventana, width=4, height=2, bg="black", state="disabled")
    ...
    timeLabel = Label(ventana, text="Tiempo de ejecución: ", bg="red", fg="white", padx=5, pady=5, font="Helvetica 25",relief="solid").place(x=5, y=700)
    timeNumbers = Label(ventana, text=time, bg="red", fg="white", font="Helvetica 25",relief="solid")
    timeNumbers.place(x=500, y=700)

    spin = Spinbox(ventana, from_=1, to=9, width=5, font="arial")
    spin.place(x=275, y=550)

    button0 = Button(ventana, width=12, height=4, bg='red', text='Fuerza \nBruta', font="Courier", fg="white",activebackground='red3', command=lambda: paint_matrix_gui(generalList, int(spin.get()),0,timeNumbers))
    button0.place(x=100, y=550)

    button1 = Button(ventana, width=12, height=4, bg='red', text='Backtracking', font="Courier", fg="white",activebackground='red4', command=lambda: paint_matrix_gui(generalList, int(spin.get()),1,timeNumbers))
    button1.place(x=375, y=550)
